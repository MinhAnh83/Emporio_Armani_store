            ...
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    <span class="user-icon">
                        <img src="<?= $_SESSION['login_avt'] ?>" alt="">
                    </span>
                    <span class="user-name"><?= $_SESSION['login_name'] ?></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                    <a class="dropdown-item" href="index.php?view=profile"><i class="dw dw-user1"></i> Profile</a>

                    <a class="dropdown-item" href="index.php?view=logout"><i class="dw dw-logout"></i> Log Out</a>
                </div>
            </div>
        </div>
    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                <li>
                    <a href="index.php?view=home" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-house-1"></span><span class="mtext">Home</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?view=user_list" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-user2"></span><span class="mtext">User</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?view=customer_list" class="dropdown-toggle no-arrow">
                        <span class="micon fi-torsos-all"></span><span class="mtext">Customer</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?view=product_list" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-shopping-bag"></span><span class="mtext">Product</span>
                    </a>
                </li>
            </ul>
        </div>
